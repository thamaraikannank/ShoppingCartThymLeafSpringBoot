...
INSERT INTO USER (user_id, password, email, username, age, gender, active, address)
VALUES
  (1, '$2a$06$OAPObzhRdRXBCbk7Hj/ot.jY3zPwR8n7/mfLtKIgTzdJa4.6TwsIm', 'user1@mail.com', 'user1', '20', 'male', 1, 'kanchi');
-- password in plaintext: "password"
INSERT INTO USER (user_id, password, email, username, age, gender, active, address)
VALUES
  (2, '$2a$06$OAPObzhRdRXBCbk7Hj/ot.jY3zPwR8n7/mfLtKIgTzdJa4.6TwsIm', 'user2@mail.com', 'user2', '21', 'male', 1, 'chennai');
-- password in plaintext: "password"
INSERT INTO USER (user_id, password, email, username, age, gender, active, address)
VALUES
  (3, '$2a$06$OAPObzhRdRXBCbk7Hj/ot.jY3zPwR8n7/mfLtKIgTzdJa4.6TwsIm', 'user3@mail.com', 'user3', '22','female', 1, 'madurai');
